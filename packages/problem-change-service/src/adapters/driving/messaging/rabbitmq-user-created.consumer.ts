...
import {
  ...
  QUEUE_USER_CREATED_PROBLEM_CHANGE,
...
export class RabbitMqUserCreatedConsumer {
  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      await this.channel.assertQueue(QUEUE_USER_CREATED_PROBLEM_CHANGE, { durable: true });
      ...
      logger.info({ queue: QUEUE_USER_CREATED_PROBLEM_CHANGE }, "RabbitMQ user.created consumer started");
    } catch (err) {
