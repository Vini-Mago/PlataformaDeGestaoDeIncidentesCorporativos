...
export const validateCreateCalendar = createValidateBody(createCalendarSchema);
export const validateCreateSlaPolicy = createValidateBody(createSlaPolicySchema);
